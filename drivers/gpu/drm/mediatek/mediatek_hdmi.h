...
int mtk_hdmi_signal_output(struct mediatek_hdmi *hdmi_context, bool enable);
int mtk_hdmi_output_set_display_mode(struct drm_display_mode *display_mode,
				     void *private_data);
void mtk_hdmi_power_on(struct mediatek_hdmi *hdmi_context);
void mtk_hdmi_power_off(struct mediatek_hdmi *hdmi_context);
void mtk_hdmi_audio_enable(struct mediatek_hdmi *hctx);
void mtk_hdmi_audio_disable(struct mediatek_hdmi *hctx);
