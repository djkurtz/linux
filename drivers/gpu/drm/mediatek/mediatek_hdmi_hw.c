...
void mtk_hdmi_hw_make_reg_writable(struct mediatek_hdmi *hdmi,
				   bool enable)
{
	invoke_psci_fn = __invoke_psci_fn_smc;
	invoke_psci_fn(MEDIATEK_SIP_TEST_CALL, 0x14000904, 0x80000000, 0);
...
void mtk_hdmi_hw_1p4_version_enable(struct mediatek_hdmi *hdmi,
				    bool enable)
{
			 ...
			 enum HDMI_DISPLAY_COLOR_DEPTH depth)
{
	...
	if ((pix == 2) &&
		...
		mtk_hdmi_mask_pll(hdmi, HDMI_CON5,
				  (hdmi->ibias_up << DRV_IBIAS_CLK_SHIFT),
				  RG_HDMITX_DRV_IBIAS_CLK);
		mtk_hdmi_mask_pll(hdmi, HDMI_CON5,
				  hdmi->ibias_up << DRV_IBIAS_D2_SHIFT,
				  RG_HDMITX_DRV_IBIAS_D2);
		mtk_hdmi_mask_pll(hdmi, HDMI_CON5,
				  hdmi->ibias_up << DRV_IBIAS_D1_SHIFT,
				  RG_HDMITX_DRV_IBIAS_D1);
		mtk_hdmi_mask_pll(hdmi, HDMI_CON5,
				  hdmi->ibias_up << DRV_IBIAS_D0_SHIFT,
		...
		mtk_hdmi_mask_pll(hdmi, HDMI_CON5,
				  hdmi->ibias << DRV_IBIAS_CLK_SHIFT,
				  RG_HDMITX_DRV_IBIAS_CLK);
		mtk_hdmi_mask_pll(hdmi, HDMI_CON5,
				  hdmi->ibias << DRV_IBIAS_D2_SHIFT,
				  RG_HDMITX_DRV_IBIAS_D2);
		mtk_hdmi_mask_pll(hdmi, HDMI_CON5,
				  hdmi->ibias << DRV_IBIAS_D1_SHIFT,
				  RG_HDMITX_DRV_IBIAS_D1);
		mtk_hdmi_mask_pll(hdmi, HDMI_CON5,
				  hdmi->ibias << DRV_IBIAS_D0_SHIFT,
				  RG_HDMITX_DRV_IBIAS_D0);
	}
}

int mtk_hdmi_hw_set_clock(struct mediatek_hdmi *hdmi, u32 clock)
{
	int ret;

	ret = mtk_hdmi_clk_sel_div(hdmi,
	...
	if (clock <= 27000000) {
		mtk_hdmi_clk_set_rate(hdmi,
				      MEDIATEK_HDMI_CLK_TVDPLL,
				      clock * 8 * 3);
		mtk_hdmi_clk_sel_div(hdmi,
...
void mtk_hdmi_hw_htplg_irq_disable(struct mediatek_hdmi *hdmi)
{
